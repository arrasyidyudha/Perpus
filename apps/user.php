               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item ">
                                    <a href="?page=main" class="nav-link active">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="?page=daftar_buku" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fa fa fa-th-list"></i>
                                <p>
                                Menu
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="?page=peminjaman" class="nav-link">
                                        <i class="far fa fa-chevron-circle-right nav-icon"></i>
                                        <p>Peminjaman</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="?page=pengembalian" class="nav-link">
                                        <i class="far fa fa-chevron-circle-right nav-icon"></i>
                                        <p>Pengembalian</p>
                                    </a>
                                </li>
