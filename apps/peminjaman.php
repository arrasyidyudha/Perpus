...
<h1 class="text-black-30 mx-auto mt-2 mb-3">Form Peminjaman</h1>
	...
	<div class="col-md-4 mb-3">
			...
			<div class="col-md-5 mb-3 ml-5">
			      ...
			      <input name="kode"  type="text" class="form-control" id="validationCustom01" placeholder="" required autocomplete="off">
			</div>
			</div>
	<div class="form-row">
	<div class="col-md-4 mb-3">
			...
			<div class="col-md-5 mb-3 ml-5">
			      ...
			      <input name="judul"  type="text" class="form-control" id="validationCustom01" placeholder="" required autocomplete="off">
			</div>
			</div>
